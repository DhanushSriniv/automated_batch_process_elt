...
CREATE TABLE silver.bst_station_information (
...
-- 2. station_status
CREATE TABLE silver.bst_station_status (
    station_id VARCHAR(100) PRIMARY KEY,
...
CREATE TABLE silver.bst_system_information (
...
-- 5. System Regions
CREATE TABLE silver.bst_system_regions (
